...
<head>
    ...
    <title>Scandiweb-task</Scandiweb-task></title>
    <link rel="stylesheet" href="./public/style/style.css">
    <script src="../public/javascript/typeSwitcher.js"></script>
</head>
<body>
    <h1>Product Add</h1>
    <a href="http://localhost/scandiweb-task/products">View products</a><br></br>
    <form action="http://localhost/scandiweb-task/products/createProduct" method="POST">
        ...
        onClick="document.location.href='http://localhost/scandiweb-task/products';" />
    </form>
</body>
</html>